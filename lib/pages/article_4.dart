          ...
          children: <Widget>[
            const ListTile(
              ...
              subtitle: Column(
                        ...
                        children: [
                          Text('#01-04 East Coast Seafood Centre, 1202 East Coast Parkway'),
                          Row(
                            children: [
            ...
            const ListTile(
              ...
              subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('1 Kadayanallur St, #01-10/11 Maxwell Food Centre'),
                          Row(
                            children: [
                              Icon(Icons.star, color: Colors.yellow),
                              Icon(Icons.star, color: Colors.yellow),
            ...
            const ListTile(
              ...
              subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('16 Bedok South Road, #01-41 Bedok South Market & Food Centre'),
                          Row(
                            children: [
                              Icon(Icons.star, color: Colors.yellow),
                              Icon(Icons.star, color: Colors.yellow),
            ...
            const ListTile(
              ...
              subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('#01-106, Boon Lay Place Market and Food Centre, 221 Boon Lay Place'),
                          Row(
                            children: [
                              Icon(Icons.star, color: Colors.yellow),
                              Icon(Icons.star, color: Colors.yellow),
            ...
            const ListTile(
              ...
              subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('1220 East Coast Parkway, East Coast Lagoon Food Village'),
                          Row(
                            children: [
                              Icon(Icons.star, color: Colors.yellow),
                              Icon(Icons.star, color: Colors.yellow),
            ...
            const ListTile(
              ...
              subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Chomp Chomp Food Centre, 20 Kensington Park Road'),
                          Row(
                            children: [
                              Icon(Icons.star, color: Colors.yellow),
                              Icon(Icons.star, color: Colors.yellow),
            ...
            const ListTile(
              ...
              subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('328 Katong Laksa, 53 East Coast Road, Singapore'),
                          Row(
                            children: [
                              Icon(Icons.star, color: Colors.yellow),
                              Icon(Icons.star, color: Colors.yellow),
